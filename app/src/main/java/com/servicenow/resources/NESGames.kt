...
object NESGames {
    val list = arrayOf(
        Game(
            "Castlevania",
            "Castlevania",
            "Vampire hunters fight with Dracula",
        ...
        Game(
            "Kirby",
            "Kirby",
            "Action, platform and puzzle solving",
        ...
        Game(
            "Super Mario Bros",
            "MarioBros",
            "Side-scrolling adventure to rescue Princess",
        ...
        Game(
            "Metroid",
            "Metroid",
            "Dark depths of a strange planet",
